...
use Olimpo\SkyWarsTeam\Resetmap;
use Olimpo\SkyWarsTeam\RefreshArena;

class SkyWarsTeamOlimpo extends PluginBase implements Listener {
				...
				if($player->isOp())
				{
					...
					else
					{
						$player->sendMessage($this->prefix . "/stm <make-leave> : Create Arena | Leave the game");
                                                $player->sendMessage($this->prefix . "/rankstm <Rank> <Player> : Set Rank(Ranks: MasterDios, MasterDios+, Dios+, Dios)");
